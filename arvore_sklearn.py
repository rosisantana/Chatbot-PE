...
'sqft_basement','yr_built','yr_renovated',	'preco_area_construida','zipcode', 'class'], axis='columns', inplace=True)

clf = tree.DecisionTreeClassifier(min_samples_leaf=6, min_impurity_decrease=0.002) #<- TUDO DE BOM 
#clf = tree.DecisionTreeClassifier(min_samples_leaf=8, min_impurity_decrease=0.002) #<- TUDO DE BOM 
...
graph.render("arvore_de_decisao_menos_dez_discretizados2") 
